...
public class AddGalleryToMuseum extends Command {
	private Gallery gallery;
	private Museum rootMuseum;
	private MuseumName museumName;

	public AddGalleryToMuseum(String id, Gallery gallery, Museum rootMuseum, MuseumName museumName) {
		super(id);
	...
	public void executeCommand() {
		...
		museum.addGallery(this.gallery);
	}
